...
public class ClienteController implements Initializable {
    ...
    private void aplicarIdioma(ResourceBundle rb) {
        try {
            if (lbl_tituloBuscar != null) lbl_tituloBuscar.setText(t(rb, "clientes.titulo.buscar", "BUSCAR CLIENTES"));
            if (btn_nuevo != null) btn_nuevo.setText(t(rb, "clientes.btn.nuevo", "Nuevo Cliente"));
            if (btn_cerrar != null) btn_cerrar.setText(t(rb, "clientes.btn.cancelar", "Cancelar"));
            if (rad_cedula != null) rad_cedula.setText(t(rb, "clientes.radio.cedula", "Cédula"));
            if (rad_nombres != null) rad_nombres.setText(t(rb, "clientes.radio.nombres", "Nombres"));
            if (col_cedula != null) col_cedula.setText(t(rb, "clientes.col.cedula", "Cédula"));
            if (col_nombres != null) col_nombres.setText(t(rb, "clientes.col.nombres", "Nombres"));
            if (col_direccion != null) col_direccion.setText(t(rb, "clientes.col.direccion", "Dirección"));
        } catch (Exception e) {}
    }
